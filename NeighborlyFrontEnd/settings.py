...
#SERVER_HOST = 'https://cebuckneighborly.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://cebuckneighborlyapi.azurewebsites.net/api/"
